    ...
    <div class="maintenance-view">
        <div class="maintenance-view__header">
            <div class="maintenance-view__title-area">
                ...
                <p class="maintenance-view__subtitle">Directly override inherited group permissions for specific users</p>
            </div>
            <button 
            ...
            <div class="matrix-content">
                ...
                <div v-if="!selectedUser" class="empty-state border-dashed">
                    ...
                    <span class="empty-state__sub">
                        Please select a user from the dropdown above to view their effective group-inherited permissions and configure individual Allow/Deny policy overrides.
                    </span>
                </div>
                            ...
                            >
                                ...
                                <div class="segmented-control">
                                    ...
                                    <label class="segmented-control__item">
                                        ...
                                        />
                                        <span class="segmented-control__button segmented-control__button--allow">Allow</span>
                                    </label>
                                    <label class="segmented-control__item">
                                        <input 
                                            type="radio" 
                                        ...
                                        />
                                        <span class="segmented-control__button segmented-control__button--deny">Deny</span>
                                    </label>
                                </div>
                            </div>
                        </div>
    ...
    try {
        ...
        userOverrides.value.forEach((overrideType, normalCode) => {
            if (overrideType === "allow") {
                ...
                if (normalPerm) {
                    const invertedPerm = allPermissions.value.find(x => 
                        x.subject === normalPerm.subject && x.action === normalPerm.action && x.inverted
                    );
...
.override-box {
    ...
    // 变道 A: 点亮 Allow 态 (清新绿)
    &--allow {
        border-left: 5px solid #22c55e !important; background-color: rgba(34, 197, 94, 0.03) !important;
        border-color: rgba(34, 197, 94, 0.2) !important;
        .override-box__action { color: #16a34a; }
    }
    // 变道 B: 点亮 Deny 态 (警示红)
    &--deny {
        border-left: 5px solid #ef4444 !important; background-color: rgba(239, 68, 68, 0.03) !important;
        border-color: rgba(239, 68, 68, 0.2) !important;
        .override-box__action { color: #dc2626; }
    }
}
...
.segmented-control {
    ...
    input:checked + &__button--deny {
        background-color: #ef4444 !important; color: white !important; box-shadow: 0 3px 8px rgba(239, 68, 68, 0.25);
    }
}
